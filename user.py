from space import view_available_spaces, book_space, view_booking_history, filter_spaces, sort_spaces, format_spaces, cancel_booking
...
def user_menu(current_user):
    ...
    actions = {
        1: view_spaces,
        2: book_space_wrapper,
        3: view_history,
        4: sort_spaces_wrapper,
        5: filter_spaces_wrapper,
        6: cancel_booking_wrapper,
        7: logout
    }
